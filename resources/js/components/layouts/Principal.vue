    ...
    <aside class="main-sidebar bg-pale-secondary">
      ...
      >
        <div class="header-sidebar" slot="header">
          <center>
            <vs-avatar size="70px" :src="'fotos/' + this.$auth.user().foto" />
          </center>
        ...
        <router-link :to="{ name: 'dashboard' }" class="nav-link">
          <vs-sidebar-item index="1" icon="home"> Home </vs-sidebar-item>
        </router-link>

        <router-link :to="{ name: 'proyectos' }" class="nav-link">
          <vs-sidebar-item index="2" icon="import_contacts">
            Proyectos
          </vs-sidebar-item>
        </router-link>
